...
def parse_opt():
    ...
    # # Data input settings
    parser.add_argument('--path_opt', type=str, default='./noc_coco_1.yml',
                        help='')
    parser.add_argument('--dataset', type=str, default='coco', help='')
    parser.add_argument('--input_json', type=str,
                        default='./data/noc_coco/cap_coco.json',
                        help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_dic', type=str,
                        default='./data/noc_coco/dic_coco.json',
    ...
    parser.add_argument('--decode_noc', type=bool, default='noc',
                        help='decoding option: normal | noc')
    parser.add_argument('--att_model', type=str, default='topdown',
                        help='different attention model, now supporting topdown | att2in2 | newtopdown')
    ...
    parser.add_argument('--finetune_cnn', action='store_true', default=True,
                        help='finetune CNN')
    ...
    parser.add_argument('--load_best_score', type=int, default=0,
                        help='Do we load previous best score wbeen resuming training.')
    ...
    parser.add_argument('--cbs', type=bool, default=True,
                        help='whether use constraint beam search.')
    parser.add_argument('--cbs_tag_size', type=int, default=2,
                        help='whether use constraint beam search.')
    ...
    parser.add_argument('--det_oracle', type=bool, default=True,
