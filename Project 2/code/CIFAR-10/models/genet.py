...
class GeResNeXt(nn.Module):
    def __init__(self, cardinality, depth, base_width, num_classes=10, expansion=4):
...
def GeResNeXt29_8x64d():
    return GeResNeXt(cardinality=8, depth=29, num_classes=10, base_width=64)


def GeResNeXt29_16x64d():
    return GeResNeXt(cardinality=16, depth=29, num_classes=10, base_width=64)
