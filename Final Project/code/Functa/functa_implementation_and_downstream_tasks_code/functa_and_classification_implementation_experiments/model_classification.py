...
class ResNet18_CD_PreActivation(nn.Module):
    def __init__(self) -> None:
        ...
        self.layer_setup1 = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=64, kernel_size=3, stride=1, padding=1),
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
            nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1),
        ...
        self.layer_setup2 = nn.Sequential(
    ...
    def forward(self, x):
        self.out_layer_setup1 = self.layer_setup1(x)
        self.out_layer_setup2 = self.layer_setup2(self.out_layer_setup1)
        
        # self.out_layer1_block1 = self.layer1_block1(self.out_layer_setup)
        self.out_layer1_block1 = self.layer1_block1(self.out_layer_setup2) + self.identity11(self.out_layer_setup2)
