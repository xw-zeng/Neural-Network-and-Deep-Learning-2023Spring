'''
ViT training on CIFAR-10 dataset
Antarang Poogalia
Mihir Goyenka
...
if __name__ == '__main__':
    ...
    parser.add_argument('--aug', action='store_true',
                        help='add image augumentations')
    parser.add_argument('--mixup', action='store_true',
                        help='add mixup augumentations')
    parser.add_argument('--net', default='vit')
    parser.add_argument('--bs', default=64)  # default original =64
    parser.add_argument('--n_epochs', type=int, default=100)  # default=100
    ...
    trainloader = torch.utils.data.DataLoader(
        trainset, batch_size=bs, shuffle=True, num_workers=0)  # bs=bs, workers=8
